...
export default function LoginScreen() {
  ...
  }, [email, password, login, clearAuthError, router, nextRoute]);
      ...
      >
        ...
        >
          <View style={styles.header}>
            ...
            <Text style={styles.subtitle}>Sign in to save and view your practice history.</Text>
          </View>
          ...
          <View style={styles.footer}>
            <Text style={styles.footerText}>New to PitchPilot?</Text>
            <TouchableOpacity
              onPress={() =>
                router.push({ pathname: '/register', params: { next: nextRoute } } as any)
              }
              activeOpacity={0.7}
            >
