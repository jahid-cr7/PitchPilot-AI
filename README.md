...
| **Robot Coach Lesson** | AI-generated video-style lesson with animated avatar, TTS, subtitles, and step-by-step coaching cards based on session weaknesses. Lessons are saved for replay later (v1.4.0) |
